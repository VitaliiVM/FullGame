...
public class kresTicNolik {
    ...
    public static void gameStart() throws IOException {
        ...
        for (int win = 0; win <= 3; ) {
                ...
                if (x == 1 && gameField[0][0] == "1") {
                    gameField[0][0] = "X";
                } else if (x == 2 && gameField[0][1] == "2") {
                    gameField[0][1] = "X";
                } else if (x == 3 && gameField[0][2] == "3") {
                    gameField[0][2] = "X";
                } else if (x == 4 && gameField[1][0] == "4") {
                    gameField[1][0] = "X";
                } else if (x == 5 && gameField[1][1] == "5") {
                    gameField[1][1] = "X";
                } else if (x == 6 && gameField[1][2] == "6") {
                    gameField[1][2] = "X";
                } else if (x == 7 && gameField[2][0] == "7") {
                    gameField[2][0] = "X";
                } else if (x == 8 && gameField[2][1] == "8") {
                    gameField[2][1] = "X";
                } else if (x == 9 && gameField[2][2] == "9") {
                    gameField[2][2] = "X";
                } else {
                ...
                if (o == 1 && gameField[0][0] == "1" ) {
                    gameField[0][0] = "O";
                } else if (o == 2 && gameField[0][1] == "2") {
                    gameField[0][1] = "O";
                } else if (o == 3 && gameField[0][2] == "3") {
                    gameField[0][2] = "O";
                } else if (o == 4 && gameField[1][0] == "4") {
                    gameField[1][0] = "O";
                } else if (o == 5 && gameField[1][1] == "5") {
                    gameField[1][1] = "O";
                } else if (o == 6 && gameField[1][2] == "6") {
                    gameField[1][2] = "O";
                } else if (o == 7 && gameField[2][0] == "7") {
                    gameField[2][0] = "O";
                } else if (o == 8 && gameField[2][1] == "8") {
                    gameField[2][1] = "O";
                } else if (o == 9 && gameField[2][2] == "9") {
                    gameField[2][2] = "O";
                } else {
                    System.out.println("Неверный ввод: попробуйте еще раз");
                    continue;
